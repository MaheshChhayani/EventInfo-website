					...
					<span id="form_response"></span>
 					<table class="table table-striped">
						 ...
						 <?php
								 ...
								 $result = mysqli_query($conn,"SELECT * from photos ORDER BY p_id DESC");
...
if(isset($_POST['add'])) {
 ...
 move_uploaded_file($book_CoverTMP, $folder.$book_Cover);
		...
		if($book_name ==null && $category_name == null && $book_Cover == null )
		{
		...
		{
			$sql = "INSERT INTO `photos`(`category`, `title`, `image`)VALUES('$category_name','$book_name','$book_Cover')";

    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Reset Admin Info</h2>
                    <form method="post" action="send_link.php">
                                                
                        <div class="input-group">
							  <label class="input--style-3" >Email</label>
                            <input class="input--style-3" type="email" name="email" required>
                        </div>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" id="submit_email" name="submit_email" type="submit" value="submit">Reset</button>
                        </div>

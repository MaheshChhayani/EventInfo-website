...
while($row = mysqli_fetch_array($tab_result))
{
 ...
 $product_query = "SELECT * FROM videos WHERE category = '".$row["category_name"]."' ORDER BY id DESC";
 $product_result = mysqli_query($connect, $product_query);
 while($sub_row = mysqli_fetch_array($product_result))
 {
  $tab_content .= '
  <div class="col-md-3 events" style="margin-bottom:36px;">
   <img src="admin/uploaded/'.$sub_row["thumb"].'" class="img-responsive img-thumbnail"   height="191" width="369" />
   
   <p style="margin-top:5px;"><b><h3><a href="watch.php?id='.$sub_row["id"].'">'.$sub_row["name"].'</a></h3></b></p>

...
<body>
    ...
    <!-- ============================================================== -->
                ...
                $email_id= $_POST['email'];
                    ...
                    while(1){
                      ...
                      if($count==1){
                        ...
                        while($data=mysqli_fetch_array($result))
                        {
                          ...
                          $email=md5($data['a_email']);
                          $pass=md5($data['a_password']);
                        }
                        break;
                      }
                      ...
                      if($not_found == 1){
                    $link="<a href='localhost/eve2/reset_pass.php?key=".$email."&reset=".$pass."'>Click To Reset password</a>";
					...
					<?php echo '<html><body><h3>Go back to</h3><a href="login.php"><h3>Login</h3></a><h3> page</h3></body></html>'?>
                    <?php
                    }
                    else
                    {
